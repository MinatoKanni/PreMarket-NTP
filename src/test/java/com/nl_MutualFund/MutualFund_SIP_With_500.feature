...
#Scenario: User Check SIP With ₹500 functionality
#
#When Navigate To Home Page  
#And User MouseOver Dashboard and Click Mutual Funds
#And User Click The Collections Options "SIP With ₹500" button
...
And User MouseOver Dashboard and Click Mutual Funds
And User Click The Collections Options "SIP With ₹500" button
And User select the price adjustment "80"
Then  Next Page Shown    
...
And User MouseOver Dashboard and Click Mutual Funds
And User Click The Collections Options "SIP With ₹500" button
And User select the price adjustment "60"
Then  Next Page Shown
